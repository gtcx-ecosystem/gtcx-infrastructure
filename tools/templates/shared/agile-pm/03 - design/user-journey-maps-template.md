# User Journey Maps Template - [PROJECT_NAME]
...
- [Missing] **Generic personas** - Make them specific and realistic
- [Missing] **Linear journeys** - Real user journeys are often complex
- [Missing] **Missing emotions** - Emotions drive user behavior
- [Missing] **No pain points** - Every journey has friction points
- [Missing] **Unclear metrics** - Define measurable success criteria
