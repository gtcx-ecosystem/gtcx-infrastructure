# Compliance Framework Template - [PROJECT_NAME]
...
| Standard/Regulation | Scope | Compliance Status | Last Audit | Next Review | Certification |
|-------------------|-------|-------------------|------------|-------------|--------------|
...
| Risk | Mitigation Strategy | Controls | Monitoring | Review |
|------|-------------------|----------|------------|--------|
...
- [Missing] **Static framework** - Update regularly based on changes
- [Missing] **Poor communication** - Keep stakeholders informed
- [Missing] **Inadequate training** - Invest in team development
- [Missing] **Weak monitoring** - Implement robust monitoring
- [Missing] **No review process** - Regular framework reviews
