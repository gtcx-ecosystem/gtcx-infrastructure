# Feature Stories & Epics Template - [PROJECT_NAME]
...
- [Missing] **Epics too large** - Break into manageable pieces
- [Missing] **Unclear user stories** - Use INVEST criteria
- [Missing] **Missing acceptance criteria** - Define clear requirements
- [Missing] **Poor estimation** - Use story points consistently
- [Missing] **No success metrics** - Define measurable outcomes
