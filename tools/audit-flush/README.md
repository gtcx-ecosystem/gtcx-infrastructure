...
See [`docs/operations/runbooks/audit-flush-deployment.md`](../../docs/operations/runbooks/audit-flush-deployment.md) for the IRSA role wiring + image build + verification steps.
