...
- `tools/eval-pipeline/eval.mjs`
- `tools/eval-pipeline/benchmarks/*.json`
...
- [ ] Model card updated (`docs/ml/model-cards/`)
...
- Model cards: `docs/ml/model-cards/`
- Benchmarks: `tools/eval-pipeline/benchmarks/`
- CI gate: `.github/workflows/eval-pipeline.yml`
- Anomaly detector: `tools/anomaly-detector/detector.mjs`
- Break-glass: `docs/security/break-glass-procedure.md`
