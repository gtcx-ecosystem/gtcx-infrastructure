...
const POLICY_PATH = `infra/kubernetes/overlays/${ENV}/linkerd/mesh-policies.yaml`;
const CANARY_PATH = `infra/kubernetes/overlays/${ENV}/linkerd/canary-rollout.yaml`;
const BASE_SERVICES = 'infra/kubernetes/base/services';
