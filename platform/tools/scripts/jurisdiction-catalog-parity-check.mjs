...
const CATALOG = join(ROOT, 'platform/tools', 'compliance-data', 'jurisdictions.json');
const VARIABLES = join(ROOT, 'deploy/terraform', 'modules', 'compliance-db', 'variables.tf');
