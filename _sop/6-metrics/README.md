...
- `_sop/2-docs/4-operations/compliance/controls-matrix.md` — compliance control evidence
- `_sop/3-agile/roadmap.md` — milestone targets
- `_sop/2-docs/3-engineering/testing.md` — coverage gate configuration
