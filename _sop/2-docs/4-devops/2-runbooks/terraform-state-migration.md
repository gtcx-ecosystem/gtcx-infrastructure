...
| Environment    | Bucket                                | Region     | Status                    |
| -------------- | ------------------------------------- | ---------- | ------------------------- |
| zimbabwe-pilot | `gtcx-terraform-state-zimbabwe-pilot` | af-south-1 | LOCAL (pending migration) |
| ghana-pilot    | TBD                                   | af-south-1 | NOT DEPLOYED              |
| rwanda-pilot   | TBD                                   | af-south-1 | NOT DEPLOYED              |
