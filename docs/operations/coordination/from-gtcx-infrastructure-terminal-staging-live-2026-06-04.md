...
- Terminal-os outbound: `terminal-os/docs/coordination/to-gtcx-infrastructure-w2-ops-001-terminal-staging-2026-06-05.md`
- Infra manifests: `infra/kubernetes/overlays/staging/terminal-os/`
- Secrets module: `infra/terraform/modules/secrets/terminal-os.tf`
