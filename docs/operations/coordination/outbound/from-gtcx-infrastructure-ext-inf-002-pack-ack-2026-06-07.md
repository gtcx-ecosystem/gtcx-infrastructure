...
| Check                   | Result                                                                                                                                                             |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Core manifest on `main` | [`vendor-pen-test-pack-manifest-latest.json`](https://github.com/gtcx-ecosystem/gtcx-core/blob/main/docs/audit/evidence/vendor-pen-test-pack-manifest-latest.json) |
