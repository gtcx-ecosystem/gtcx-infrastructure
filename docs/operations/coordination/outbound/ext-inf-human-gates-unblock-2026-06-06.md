...
| DPA + pilot agreement | **EXT-INF-014** | Legal + pilot owner    | Signed DPA (ZW ↔ af-south-1) + pilot PDFs under `docs/audit/vendor-outreach/zwcmp/`                         | 2026-06-21   |
...
| Repo                | Role                                                                                                                                                                                                |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| gtcx-intelligence   | INT-S12-01 witness — [outbound chase](https://github.com/gtcx-ecosystem/gtcx-intelligence/blob/main/docs/operations/coordination/outbound/to-human-security-int-s12-01-pentest-chase-2026-06-06.md) |
