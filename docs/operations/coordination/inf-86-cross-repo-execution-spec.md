...
**Artifacts:** `docs/operations/coordination/to-gtcx-infrastructure-inf-86-ceremony-2026-06-03.md`, `inf-86-pilot-gh-bog-protocols-runbook-2026-06-02.md`
...
**Artifacts:** `scripts/trust-attestation/merge-xr401-attestation.mjs`
...
- log: docs/audit/inf-86-ceremony-tracker.md
```
