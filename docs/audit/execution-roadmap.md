...
| S2-08 | Node 20.18.0 enforcement across packages + workflows                  | **done** (working tree, 2026-05-31) — package engines, CI setup-node, shared action defaults, docs, and validate-all gate enforce 20.18.0    |
