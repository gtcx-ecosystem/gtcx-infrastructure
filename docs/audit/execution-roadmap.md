...
| S2-05 | Prometheus metrics for `/v1/exceptions` + `/v1/audit/evidence-bundle` | **done** (working tree, 2026-05-31) — route/status counters plus exception-count and evidence-record metrics added                           |
