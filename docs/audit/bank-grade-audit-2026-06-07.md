...
methodology: gtcx-docs/tools/audit/audit-framework/SCORING_FRAMEWORK.md
commit: 9d7d763
prior_bank_grade: docs/audit/master-audit-2026-06-02.md
...
**Commit:** `9d7d763`  
**Auditor:** Cursor Agent (Auto)  
**Scoring:** [`SCORING_FRAMEWORK.md`](https://github.com/gtcx-ecosystem/gtcx-docs/blob/main/tools/audit/audit-framework/SCORING_FRAMEWORK.md) + [`bank-grade-scoring.md`](https://github.com/gtcx-ecosystem/gtcx-docs/blob/main/tools/audit/lane-scoring/bank-grade-scoring.md)
...
| `node tools/scripts/validate-all.mjs`                 |    0 | **50/50** gates PASS                                                          |
| `node tools/scripts/validate-signal.mjs`              |    0 | 9.60/10 PASS                                                                  |
| `node tools/control-plane/gtcx-ctl.mjs validate --ci` |    0 | staging + production kustomize offline                                        |
