...
| --------------- | ------------------------------------------------------------------------------- | ---------------- | ---------------------------------- | ------------------------------------------------- | ----------------------------------------------------------------- | ------------------------- | ----------------------------------------------------------------------------------- | ---------------------------- |
| **EXT-INF-013** | **ZWCMP pilot — named GTCX owner + first cadence call** (S1-09)                 | External / GTM   | **TBD — escalation to leadership** | Bet 2 (sign ZWCMP); Sprint 1 close                | **open** — placeholder in `pilot-success-criteria.md:27`          | 2026-06-07 (Sprint 1 end) | Owner name in `pilot-success-criteria.md`; calendar link committed to this register | Bet 2 unblock                |
...
| **EXT-INF-002** | open — RFP/scope ready    | **escalated to P0 in execution-roadmap S2-13** (decision pending Q5) |
...
- **Q5 (Pen-test ordering)** — ratify Sprint 1 plan + execute, OR commission external review BEFORE Sprint 1 (+4w). Answer drives EXT-INF-002 ETA.
- **Q6 (Product motion: product-led vs sales-led)** — answer drives EXT-INF-013 owner choice (dev-rel-facing vs. pilot-facing seniority).
