 ...
 * Semver SoR: 01-docs/05-audit/prompts/compliance-gateway@1.0.0/ (SIGNAL INF-014).
 */
...
export function getPromptMetadata() {
  return {
    ...
    manifest: `01-docs/05-audit/prompts/compliance-gateway@${PROMPT_VERSION}/manifest.json`,
  };
}
