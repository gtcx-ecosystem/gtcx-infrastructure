...
```
platforms/
├── sgx/      → depends on: protocols/, 03-platform/packages/
├── crx/      → depends on: protocols/, 03-platform/packages/
├── agx/      → depends on: sgx/, protocols/, 03-platform/packages/
├── caas/     → depends on: protocols/, 03-platform/packages/ai/
