...
const PILOT = path.join(ROOT, '01-docs/audit/evidence/signal-trace-pilot-latest.json');
const LOG = path.join(ROOT, '01-docs/operations/coordination/cross-repo-agent-log.md');
