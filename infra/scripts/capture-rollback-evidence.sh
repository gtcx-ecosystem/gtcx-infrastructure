...
# Generated artifacts land under infra/security/reports/rollback-evidence/ by
...
if [[ -z "${OUTPUT_DIR}" ]]; then
    OUTPUT_DIR="infra/security/reports/rollback-evidence/${ENVIRONMENT}/$(date -u +%Y%m%dT%H%M%SZ)"
fi
