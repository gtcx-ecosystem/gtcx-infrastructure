...
3. Append [protocols log](https://github.com/gtcx-ecosystem/gtcx-protocols/blob/main/01-docs/04-ops/coordination/cross-repo-agent-log.md)
4. `pnpm agent:next-work` if implement queue open

## Legacy inbound

Files under `01-docs/04-ops/coordination/from-*.md` remain valid — index here when touched.
