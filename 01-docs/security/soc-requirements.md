...
The SOC (internal or managed) must participate in quarterly tabletop exercises per the Incident Response Plan (`01-docs/10-compliance/incident-response-plan-v1.md`, Section 12).
