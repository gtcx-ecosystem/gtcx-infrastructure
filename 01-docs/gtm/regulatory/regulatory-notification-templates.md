...
1. The Incident Commander identifies which templates are required based on the incident scope and regulatory obligations (see IRP Section 8, `01-docs/10-compliance/incident-response-plan-v1.md`).
