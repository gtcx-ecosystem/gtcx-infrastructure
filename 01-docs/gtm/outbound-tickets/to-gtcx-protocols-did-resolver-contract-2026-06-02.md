...
- `01-docs/05-audit/execution-roadmap.md` S4-03
- `03-platform/tools/compliance-gateway/tests/audit-bundles/did-resolver.test.mjs` (test expectations)
- `01-docs/08-gtm/outbound-tickets/to-gtcx-platforms-agx-build-fix-2026-06-02.md` (AGX blocker)
