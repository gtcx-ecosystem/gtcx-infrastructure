...
| 1.8 | Generate release evidence bundle               | Not started     | **Done** — `runtime-evidence-check` dry-run gate passes; signed bundle generation verified         | `03-platform/tools/03-platform/scripts/runtime-evidence-check.mjs`                           |
