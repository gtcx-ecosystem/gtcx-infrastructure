...
review_cycle: 'weekly'
source_audit: '01-docs/05-audit/master-audit-2026-05-28.md'
prior_plan: '01-docs/05-audit/10-10-remediation-plan-2026-05-27.md'
current_composite: 8.8
internal_readiness: 10.0
target_composite: 10.0
external_register: '01-docs/05-audit/external-dependencies-register-2026-05-28.md'
---
...
> **Scoring:** `gtcx-docs/03-platform/tools/audit/audit-framework/SCORING_FRAMEWORK.md`  
...
**Reference:** `gtcx-protocols/01-docs/05-audit/ecosystem-consumption-audit-2026-05-28.md` §2.

---

## 2. Non-Negotiable 10/10 Exit Criteria

Per `gtcx-docs/03-platform/tools/audit/audit-framework/SCORING_FRAMEWORK.md` and Protocol 16:
...
| ------ | ------------------------------------------------------------------------------------------------------------- | ----------------------------------------- | ------------------------------------ |
| H0-001 | Fix broken link `01-docs/README.md` → create or restore `01-docs/engineering/tech-stack/version-standards.md` | Docs trust for all agent onboarding       | `pnpm docs:check-links` pass         |
| H0-002 | Add `01-docs/05-audit/vendor-outreach/README.md` index                                                        | Unblocks vendor SOC2/pen-test procurement | `pnpm test` docs-standard pass       |
...
| X2-002 | Document in-cluster service map: protocols → compliance-gateway → WORM                                   | gtcx-intelligence Wire #2     | `01-docs/architecture/ecosystem-service-map.md`                  |
| X2-003 | Add `03-platform/tools/contract-tests/` — verify replay headers, audit-signer NDJSON, gateway budget 429 | gtcx-protocols, gtcx-core     | CI job `protocol-contracts` green                                |
| X2-004 | Publish **downstream readiness gate** script consumed by release runbooks                                | compliance-os, gtcx-platforms | `03-platform/tools/control-plane/check-downstream-readiness.mjs` |
| X2-005 | Extend `baseline-os` ecosystem-health to call infra `pnpm test:full`                                     | Whole polyrepo                | Health workflow artifact                                         |
| X2-006 | Cross-repo version matrix: pin `@gtcx/audit-signer` across protocols + compliance-os                     | Prevent signature drift       | `01-docs/release/ecosystem-version-matrix.md`                    |
...
| A3-002 | Pen-test SOW signed; scope includes gateway, replay-protection, WORM paths, K8s admission                             | Signed SOW in `01-docs/05-audit/vendor-outreach/` |
...
| A3-004 | Map controls to SOC 2 / ISO 27001 / NIST 800-53 in `01-docs/10-compliance/evidence-index.md`                          | Single evidence index                             |
...
| I4-005 | Custom CodeQL rules for hardcoded keys in `03-platform/tools/`                          | Code Quality           |
...
3. Update README badge + `01-docs/overview/` to cite 8.8–9.0 with evidence links, not stale 5.9 — **~1 hour**
4. Post INF-49 status to gtcx-protocols `01-docs/05-audit/agile/sprints/s47-*.md` — **~30 min**
...
| `gtcx-core/01-docs/05-audit/10-10-remediation-plan-2026-05-27.md`                      | Upstream crypto — infra publishes attestations |
| `compliance-os/01-docs/05-audit/10-10-roadmap-2026-05-27.md`                           | Parallel WORM/audit alignment                  |
