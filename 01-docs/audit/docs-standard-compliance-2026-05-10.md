...
| Axis                |      Score | Findings                                                                                                                                                                                                                                             |
| ------------------- | ---------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Structural          |     7.8/10 | Canonical minimums are present; repo retains approved top-level deviations in `agents/`, `agile/`, `devops/`, `gtm/`, and `decisions/`, documented in [`01-docs/governance/documentation-deviations.md`](../governance/documentation-deviations.md). |
...
| Master INDEX        |     9.1/10 | `01-docs/README.md` remains the master index and now links the repo-local governance note; the doc count and timestamp should be refreshed again after the master audit lands.                                                                       |
...
| README-only acceptance failures                            | `01-docs/`, `01-docs/08-gtm/`    | Added [`01-docs/governance/documentation-deviations.md`](../governance/documentation-deviations.md) and [`01-docs/08-gtm/overview.md`](../gtm/overview.md) as substantive non-README anchor docs. |
| Undocumented repo-local taxonomy deviations                | `CLAUDE.md`, `01-docs/README.md` | Added an explicit governance reference for deviations from the baseline taxonomy.                                                                                                                 |
...
- `01-docs/10-compliance/policies/A05-information-security-policy.md` → `01-docs/10-compliance/policies/a05-information-security-policy.md`
- `01-docs/10-compliance/policies/A06-organization-of-information-security.md` → `01-docs/10-compliance/policies/a06-organization-of-information-security.md`
- `01-docs/10-compliance/policies/A07-human-resource-security.md` → `01-docs/10-compliance/policies/a07-human-resource-security.md`
- `01-docs/10-compliance/policies/A08-asset-management.md` → `01-docs/10-compliance/policies/a08-asset-management.md`
- `01-docs/10-compliance/policies/A09-access-control.md` → `01-docs/10-compliance/policies/a09-access-control.md`
- `01-docs/10-compliance/policies/A10-cryptography.md` → `01-docs/10-compliance/policies/a10-cryptography.md`
- `01-docs/10-compliance/policies/A11-physical-security.md` → `01-docs/10-compliance/policies/a11-physical-security.md`
- `01-docs/10-compliance/policies/A12-operations-security.md` → `01-docs/10-compliance/policies/a12-operations-security.md`
- `01-docs/10-compliance/policies/A13-communications-security.md` → `01-docs/10-compliance/policies/a13-communications-security.md`
- `01-docs/10-compliance/policies/A14-system-acquisition.md` → `01-docs/10-compliance/policies/a14-system-acquisition.md`
- `01-docs/10-compliance/policies/A15-supplier-relationships.md` → `01-docs/10-compliance/policies/a15-supplier-relationships.md`
- `01-docs/10-compliance/policies/A16-incident-management.md` → `01-docs/10-compliance/policies/a16-incident-management.md`
- `01-docs/10-compliance/policies/A17-business-continuity.md` → `01-docs/10-compliance/policies/a17-business-continuity.md`
- `01-docs/10-compliance/policies/A18-compliance.md` → `01-docs/10-compliance/policies/a18-compliance.md`

## Cross-references Updated

- Re-pointed agent workflow and onboarding docs from the obsolete numbered tree to the current `01-docs/agents`, `01-docs/operations`, `01-docs/devops`, `01-docs/architecture`, and `01-docs/decisions` paths.
