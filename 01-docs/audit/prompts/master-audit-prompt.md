...
**Output:** `01-docs/05-audit/master-audit-report-YYYY-MM-DD.md`  
**Evidence Directory:** `01-docs/05-audit/prompts/evidence/`
...
1. **Load the prompt**
   ...
   ```bash
   cat 01-docs/05-audit/prompts/<grade>-grade-audit-prompt.md
   ```

2. **Execute evidence collection**
   - Run all commands in the prompt's §2
   - Capture raw output to `01-docs/05-audit/prompts/evidence/raw/<grade>-<timestamp>.log`
...
5. **Produce evidence JSON**
   - Write to `01-docs/05-audit/prompts/evidence/<grade>-grade-evidence.json`
...
- [ ] All controls pass
- [ ] Evidence uploaded to `01-docs/05-audit/prompts/evidence/`
...
| -------------------- | ---------------------------------------------------------- | -------- |
| Master audit report  | `01-docs/05-audit/master-audit-report-YYYY-MM-DD.md`       | Markdown |
| Unified scorecard    | `01-docs/05-audit/prompts/evidence/unified-scorecard.json` | JSON     |
| Grade evidence (×5)  | `01-docs/05-audit/prompts/evidence/*-grade-evidence.json`  | JSON     |
| Raw logs             | `01-docs/05-audit/prompts/evidence/raw/*.log`              | Text     |
| Remediation roadmaps | `01-docs/05-audit/remediation-roadmap-*.md`                | Markdown |
| Executive summary    | `01-docs/05-audit/executive-summary-YYYY-MM-DD.md`         | Markdown |

---

## 8. Related Documents

- `01-docs/05-audit/audit-grade-framework.md` — Five-tier grade definitions
- `01-docs/05-audit/bank-grade-rating-framework.md` — Internal vs external dual-rating
- `01-docs/05-audit/prompts/partnership-grade-audit-prompt.md`
- `01-docs/05-audit/prompts/enterprise-grade-audit-prompt.md`
- `01-docs/05-audit/prompts/investment-grade-audit-prompt.md`
- `01-docs/05-audit/prompts/bank-grade-audit-prompt.md`
- `01-docs/05-audit/prompts/government-grade-audit-prompt.md`
