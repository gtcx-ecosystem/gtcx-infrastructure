...
- `01-docs/05-audit/bank-grade-rating-framework.md` — Internal vs external dual-rating for Bank-Grade specifically
- `01-docs/05-audit/archive/10-10-roadmap-2026-05-12.md` — Full engineering roadmap
- `01-docs/05-audit/pen-test-scope-2026.md` — Penetration test scope
- `01-docs/10-compliance/soc2-gap-analysis.md` — SOC 2 readiness checklist
- `01-docs/engineering/gtcx-platforms-m3-contract.md` — M3 cross-repo deliverables
