...
review_cycle: 'weekly'
source_audit: '01-docs/05-audit/master-audit-2026-05-30.md'
previous_plan: '01-docs/05-audit/10-10-remediation-plan-2026-05-28.md'
...
| ------ | ------- | --------------------------------------------------------------------------------- | ------------------------------------------------------- |
| G0-001 | P0-001  | Rename `01-docs/roadmap/ROADMAP-2026-07-13.md` to lowercase and update references | `pnpm quality:governance:check` passes                  |
| G0-002 | P0-001  | Add `01-docs/roadmap/README.md` or `index.md`                                     | `pnpm test` proceeds past docs-standard                 |
...
| G0-006 | P2-004  | Commit or remove `01-docs/05-audit/post-roadmap-session-2026-05-30.md`            | Open until current audit/report artifacts are committed |
...
| ID     | Action                                                                                                                              | Evidence                                                               |
| ------ | ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| X4-001 | Add contract tests for replay headers, audit-signer NDJSON, compliance catalog verification, and compliance-gateway tenant behavior | `03-platform/tools/contract-tests` or equivalent CI job green          |
