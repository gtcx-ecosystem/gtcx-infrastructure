...
| ------------------- | ----------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| **Platform**        | `gtcx-infrastructure`               | VPC, EKS, RDS, WAF, CI/CD, IAM, NetworkPolicies, observability, backup/DR | `01-docs/10-compliance/platform/`                                               |
| **Shared Services** | `gtcx-infrastructure`               | Compliance gateway, replay protection, audit logging, anomaly detection   | `03-platform/tools/compliance-gateway/`, `03-platform/tools/replay-protection/` |
| **Application**     | Each service repo                   | Business logic, API endpoints, data handling, feature-specific privacy    | `01-docs/10-compliance/service/` in each repo                                   |
| **Customer-Facing** | `gtcx-infrastructure` (coordinated) | DPA templates, trust center, security.txt, responsible disclosure         | `01-docs/10-compliance/customer-facing/`                                        |
...
- Data handling: [01-docs/10-compliance/service/data-handling.md]
```
...
- [ ] Copy `01-docs/10-compliance/service/README.md` template from `gtcx-infrastructure`
