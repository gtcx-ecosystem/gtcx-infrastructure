...
1. **Audit Events**
   ...
   - Export: `03-platform/scripts/compliance/export-audit-events.sh`
...
ORG_ID=00000000-0000-0000-0000-000000000999 \
  03-platform/scripts/compliance/export-audit-events.sh
```
...
EVIDENCE_DIR=/tmp/compliance-os-evidence \
  03-platform/scripts/compliance/generate-evidence-manifest.sh
```
...
```bash
ORG_ID=00000000-0000-0000-0000-000000000999 \
  03-platform/scripts/compliance/export-evidence-bundle.sh
```
