...
Resolved or retired risks are moved to `01-docs/10-compliance/risk-register-archive.md` with the date retired and the rationale. Risk IDs are never reused.
