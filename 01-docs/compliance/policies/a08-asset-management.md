...
2. **Classification scheme.** Assets are classified into four tiers per `01-docs/10-compliance/data-classification-policy.md`: Public, Internal, Confidential, Restricted. Classification determines encryption requirements, access controls, retention, and disposal methods.
