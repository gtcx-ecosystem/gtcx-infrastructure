...
# Collect logs
./03-platform/scripts/collect-logs.sh --system=<name> --from="2025-01-21T00:00:00Z"

# Isolate system
./03-platform/scripts/isolate.sh --system=<name> --preserve-evidence

# Check security status
../../03-platform/tools/03-platform/scripts/security-status.js
```
